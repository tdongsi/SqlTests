---
layout: post
title: "Exhaustive syllabus"
date: 2011-01-05 17:51:04 -0800
comments: true
categories: 
---
...
- [ ] [Data Structures and Algorithms in Python](https://www.amazon.com/Structures-Algorithms-Python-Michael-Goodrich/dp/1118290275/)
    - by Goodrich, Tamassia, Goldwasser (GTG)
...
It is summarized in [this post](/blog/2011/01/04/practice-for-interview/).

This list grew over many months, and yes, it kind of got out of hand. 
It is STRONGLY recommended that you use flash card for spaced repetition and Anki is a good flash card application for that purpose.
...
- ### Stack
    - Trivial implementation when using Python's list.
    - Adapter design pattern to convert Python's list to generic stack interface.

- ### Queue
    - Use Python's collections.deque for Queue.
...
- ### Heap / Priority Queue / Binary Heap
    ...
    - Know how to use `heapq` module in Python.
        - Know recipe for heapsort.

## Sorting

- [ ] Notes:
    - [Implement sorts & know best case/worst case, average complexity of each](/blog/2012/01/01/tutorial-sorting-algorithms/).
    - [MergeSort3 and Quick Select](/blog/2012/01/02/tutorial-more-about-quick-sort/)
...
For learning this topic, I'll STRONGLY RECOMMEND Chapter 14 of this book [Data Structures and Algorithms in Python](https://www.amazon.com/Structures-Algorithms-Python-Michael-Goodrich/dp/1118290275/).
...
See [Graph Data Structures](/blog/2015/05/02/graph-data-structures/) and [Graph Algorithms](/blog/2015/05/01/graph-algorithms/).
