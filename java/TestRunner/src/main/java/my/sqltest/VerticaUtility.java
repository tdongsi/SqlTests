...
public class VerticaUtility {
	
private static final Logger logger = LoggerFactory.getLogger(VerticaUtility.class);
	
	/**
	 * Override default constructor.
	 */
	private VerticaUtility() {
	 ...
	 * Basically execute the Vertica query: set search_path to schemaName1, schemaName2
	 * 
	 * @param name
	 */
